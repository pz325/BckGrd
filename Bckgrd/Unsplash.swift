...
struct UnsplashUtilities{
    static func getRandomImageUrl(completion: @escaping (String) -> Void) {
    ...
    static func downloadRandomImage(imageUrlString: String, completion: @escaping (String) -> Void) {
